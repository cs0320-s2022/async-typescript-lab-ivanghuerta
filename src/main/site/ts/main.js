...
function postAndUpdate() {
    ...
    fetch("http://localhost:4567/results", {
        ...
        .then((result) => result.json()).then((match) => {
...
document.addEventListener("keyup", () => (keyEvent) => __awaiter(void 0, void 0, void 0, function* () {
    if (keyEvent.key == "r") {
        yield updateValues("Taurus", "Pisces", "Libra");
        postAndUpdate();
    }
}));
