...
const suggestions: HTMLInputElement = document.getElementById("suggestions") as HTMLInputElement  
...
document.addEventListener("keyup", () => async (keyEvent: KeyboardEvent) => {
  if (keyEvent.key == "r") { 
    await updateValues("Taurus", "Pisces", "Libra")
    postAndUpdate()
  }
})
